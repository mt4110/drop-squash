...
#[test]
fn reports_public_web_exit_without_pricing_page() {
    let text = "\
| 3 | Public web proof | Public website deployment, Pricing finalized, Refund policy finalized, Live checkout link | Production dropsquash.app release-status, privacy, support, download, checkout, and refund links are ready before the public beta | Production website URLs |
";
...
#[test]
fn reports_public_web_exit_without_license_page() {
    let text = "\
| 3 | Public web proof | Public website deployment, Pricing finalized, Refund policy finalized, Live checkout link | Production dropsquash.app release-status, privacy, pricing, support, download, checkout, and refund links are ready before the public beta | Production website URLs |
";
