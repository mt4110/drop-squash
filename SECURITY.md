...
The production encoder will run outside the WebView/UI process with no network capability and access limited to the user-selected input and output location. Phase 0 contains backend stubs only and performs no media parsing or encoding.
