...
| Local license forget | License sandbox | Use the local forget action, confirm the action is disabled while forgetting, confirm cache removal, and inspect the returned app state | `docs/manual-qa.md` |
