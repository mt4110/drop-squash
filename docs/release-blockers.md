...
| Public website deployment | Blocked | Production website production URL `https://dropsquash.app/release-status` serves the release-status, privacy, pricing, support, and download pages on `dropsquash.app` | TBD | `https://...` |
...
| Public website deployment | Public web | Deploy the production site and verify `https://dropsquash.app/release-status` serves release-status, privacy, pricing, support, and download pages | Public website URL |
...
| 3 | Public web proof | Public website deployment, Pricing finalized, Refund policy finalized, Live checkout link | Production `https://dropsquash.app/release-status`, `https://dropsquash.app/pricing`, and `https://dropsquash.app/refund` URLs serve release-status, privacy, pricing, support, download, checkout, and refund links before the public beta | Production website URLs |
