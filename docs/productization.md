...
| 11 | Build release pipeline | In progress | Unsigned DMG QA artifact upload, release gates, artifact/checksum checks, release notes/refund URL gates, conversion/queue/Trash/license action-state release notes evidence, final publish gate, CI signing preflight, workflow coverage tests, and template coverage tests exist; signed/notarized publication remains |
