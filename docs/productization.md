...
| 7 Sales site | In progress | Let a stranger understand, download, try, and buy | Landing, pricing, privacy, download, FAQ, support | Privacy claims match implementation; CTA works; download path works | Static site draft and `website-check` exist; hosting and live checkout remain |
