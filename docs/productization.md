...
| 8 | Add sequential queue | In progress | Queue model, React sequential runner, Rust queue commands, web wire mapping, queued job cancellation, and batch summary are implemented; reproducible `docs/manual-qa.md` multi-file, queued-cancellation, and batch-summary evidence remains |
