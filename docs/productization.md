...
| 11 | Build release pipeline | In progress | Unsigned DMG QA artifact upload, release gates, artifact/checksum checks, final publish gate, and CI signing preflight exist; signed/notarized publication remains |
