...
| Release notes preparation | Release notes artifact fields are generated from the checked public `DropSquash.dmg`, public Artifact URL, checksum, version, and current git commit | `cargo run -p xtask -- release-notes-prepare path/to/DropSquash.dmg <Artifact URL>` |
