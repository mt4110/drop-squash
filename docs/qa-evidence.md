...
| Static site | Required pages, local links/resources, approved external links, placeholders, unsupported platform availability claims, release-status, privacy, license, refund, support contact copy, pre-release CTA copy, and pre-release download/checkout links or form actions are checked | `cargo run -p xtask -- website-check` |
